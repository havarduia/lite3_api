...
"""demo.py - a guided tour of the lite3 API. Run the lessons in order.
    ...
    source ~/lite3_env.sh          # ALWAYS do this first
    python3 demo.py                # list the lessons
    python3 demo.py 1              # run one lesson
    python3 demo.py read           # run every lesson that cannot move the robot

Lessons 5 and up move the robot, so they refuse to run unless you add --move:

    python3 demo.py 5 --move
