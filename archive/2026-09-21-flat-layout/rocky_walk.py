...
"""The robot walks a route and says what he sees along the way (--persona).
    ...
    python3 rocky_walk.py --speed 0.2 "walk 3"
    python3 rocky_walk.py --dry-run                # comments only, no movement
    python3 rocky_walk.py --finale "roast the person in front of you" "goto 2.8"
